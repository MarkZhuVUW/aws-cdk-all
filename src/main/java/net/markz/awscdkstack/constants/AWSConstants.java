...
public enum AWSConstants {
    ...
    WEBSCRAPERSERVICE_DYNAMODB_TABLE_ONLINESHOPPINGITEMS("OnlineShoppingItems"),
    WEBSCRAPERSERVICE_SQS_QUEUE_NAME("webscraper-sqs-queue"),
    WEBSCRAPERSERVICE_SQS_DLQ_NAME("webscraper-sqs-dlq"),
    WEBSCRAPERSERVICE_SQS_VISIBILITY_TIMEOUT_MINUTES("60"),
    WEBSCRAPERSERVICE_REDIS_CLUSTER_NAME("WebscraperServiceRedisCluster");
